    ...
    <template v-if="!isAdded">
      ...
      >
        <form action="" class="flex flex-col gap-6 mt-8">
          <BaseInput label="Ancien mot de passe" type="password" />
          <BaseInput label="Nouveau mot de passe" type="password" />
        </form>
        <template #footer>
          <div class="flex mt-6">
    ...
    <template v-else>
      ...
      >
        <div class="flex flex-col items-center gap-6 px-6">
          ...
          <div class="font-bold text-xl">Mot de passe modifié avec succès</div>
        </div>
        <template #footer>
          <div class="flex mt-6">
