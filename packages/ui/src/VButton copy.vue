<template>
  <component
    ...
    :to="to"
    :href="href"
    class="relative inline-flex items-center justify-center rounded-lg border-2 cursor-pointer focus:outline-none focus:ring-2"
  ...
  >
    ...
    <div
      v-show="loading"
      class="absolute inset-0 flex items-center justify-center pointer-events-none bg-transparent"
    >
      <svg
